...
def parse_args():
    parser = argparse.ArgumentParser(description="Download NVIDIA Cosmos Predict1 DiffusionRenderer models from Hugging Face")
    parser.add_argument(
...
MD5_CHECKSUM_LOOKUP = {
    ...
    "Diffusion_Renderer_Inverse_Cosmos_7B/model.pt": "77eb5beddf131bfc8235a300132f22e4",
    "Diffusion_Renderer_Forward_Cosmos_7B/model.pt": "2b664e2d1872873ee9089a3f2071f25d",
}
