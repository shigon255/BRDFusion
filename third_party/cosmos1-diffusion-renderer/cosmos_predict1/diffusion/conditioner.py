...
@dataclass
class VideoDiffusionRendererCondition(BaseVideoCondition):
...
class VideoDiffusionRendererConditioner(GeneralConditioner):
    def forward(
        self,
        batch: Dict,
        override_dropout_rate: Optional[Dict[str, float]] = None,
        ...
        output = super()._forward(batch, override_dropout_rate)
        return VideoDiffusionRendererCondition(**output)
