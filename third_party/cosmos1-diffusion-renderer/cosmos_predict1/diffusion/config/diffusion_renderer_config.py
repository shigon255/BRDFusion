...
from cosmos_predict1.diffusion.config.base.model import DiffusionRendererConfig
...
def make_config():
    """Create a configuration specifically for diffusion renderer inference."""
    c = Config(
        model=DiffusionRendererConfig(),
    )

    # Specifying values through instances of attrs
    c.job.project = "cosmos_diffusion"
    c.job.group = "diffusion_renderer_inference"
